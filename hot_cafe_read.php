...
<body>
    <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" role="form" enctype="multipart/form-data">
        <div class="cafe_table">
            <div class="c">
                <?php
                echo '<h1 class="title">Hot Cafe Menu</h1>';
                $sql = "SELECT * FROM hotcate";
        ...
        <button class="btn btn-success s-button"><a href="http://localhost/2cafe/test/admin/admin_addhotcafe.php">add new</a></button>
...
//         $ins_user = $con->prepare("INSERT INTO hotcate (name, price, image) VALUES (?, ?, ?)");
